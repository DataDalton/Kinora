...
export default function AnimePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-pink-600/10 via-purple-600/10 to-red-600/10 border-b-2 border-border">
        <div className="container mx-auto px-6 py-8">
          <h1 className="text-4xl font-bold mb-2">Anime</h1>
          <p className="text-muted-foreground">Manage and track your anime collection</p>
        </div>
      </div>
          ...
          <>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
              {filteredAnime.map((anime: Anime) => (
                <div key={anime.id} className="bg-card text-card-foreground rounded-lg shadow border-2 border-border overflow-hidden hover:shadow-lg hover:border-primary/50 transition">
            ...
            <div className="mt-8 flex justify-center gap-2">
              ...
              <button
                ...
                disabled={!data?.anime || data.anime.length < 20}
                className="px-4 py-2 bg-card border border-border text-foreground rounded-lg disabled:opacity-50 hover:bg-accent transition"
              >
                Next
              </button>
