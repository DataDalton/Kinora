...
export interface MediaProfileFormData {
	...
	upgrade_replace_policy: "keep_old" | "delete_old" | "keep_versions";
	...
	// Seeding overrides (null = inherit global download-client default)
...
export type ProfileTab = "general" | "languages" | "validation" | "seeding";
