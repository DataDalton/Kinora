    ...
    return (
      <div className="space-y-6">
        ...
        <div className={`p-4 rounded-lg border-2 ${
          ...
          />
          {hasAttemptedSubmit && !formData.name.trim() && (
            <p className="text-xs text-destructive mt-1">Profile name is required</p>
          )}
        </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="space-y-3 p-4 rounded-lg border-2 border-transparent">
          <div>
            <label className="block text-sm font-semibold mb-2">Audio Languages</label>
            <p className="text-xs text-muted-foreground mb-2">Add preferred audio languages in order of priority</p>
        ...
        <div className="space-y-3 p-4 rounded-lg border-2 border-transparent">
          <div>
            ...
            <p className="text-xs text-muted-foreground mb-2">Optional: Add subtitle languages to download. Leave empty to skip subtitle downloads.</p>
