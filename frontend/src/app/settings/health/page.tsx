...
import type { RootFolder, FolderHealthSummary, DriveStats } from '@/types/root-folder';
import {
  HardDrive,
  CheckCircle,
  AlertTriangle,
                    ...
                    {drive.folders.length > 0 && (
                      <div className="border-t border-border pt-3 mt-3">
                        ...
                        <div className="space-y-1">
                          {drive.folders.slice(0, 3).map((folder) => (
                          ...
                          {drive.folders.length > 3 && (
                            <div className="text-xs text-muted-foreground">
                              +{drive.folders.length - 3} more
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      >
                        <td className="px-4 py-3 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            ...
                            {folder.isDefault && (
                              <span className="px-1.5 py-0.5 bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200 text-xs rounded">
                                Default
                              </span>
                            )}
                          </div>
